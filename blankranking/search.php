...
?>
  <div class="w3-center w3-padding-32 ">
    <div class="w3-bar">
        ...
        <li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?type=<?php echo $_GET['type']?>&page=<?php echo $page-1?>"><<</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?type=<?php echo $_GET['type']?>&page=1">1</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?type=<?php echo $_GET['type']?>&page=2">2</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?type=<?php echo $_GET['type']?>&page=3">3</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?type=<?php echo $_GET['type']?>&page=<?php echo $page+1?>">>></a></li>
  		</ul>
    </div>
  </div>
...
?>
  <div class="w3-center w3-padding-32 ">
    <div class="w3-bar">
    	<ul class="pagination justify-content-lg-between" style="margin:20px 0">
        <li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?&page=<?php echo $page-1?>"><<</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?page=1">1</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?page=2">2</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?page=3">3</a></li>
  		<li class="page-item"><a class="w3-bar-item w3-button w3-hover-black" href="search.php?&page=<?php echo $page+1?>">>></a></li>
  		</ul>
    </div>
  </div>
