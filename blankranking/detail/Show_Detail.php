...
//นำค่าจาก database มาเก็บไว้ที่ตัวแปร
...
<button href="javascript:void(0)" type="button" class="btn btn-light" style="background-color: rgba(0, 0, 0, 0.6); color: #fff;" onclick="document.getElementById('Vote').style.display='block'">
  <i class="fa fa-star" style="color: #FFD700; "></i>
  <b style="color: #fff;  ">   Vote   </b>
</button>
...
<div id="Vote" class="w3-modal">
  ...
  <div class="w3-modal-content w3-animate-zoom" style="padding:20px; max-width: 550px;">
    <div class="w3-container w3-white w3-center ">
      ...
      <input class="w3-input w3-border" type="text" id="name" name="name" placeholder="ชื่อผู้รีวิว.. " style="font-family: Roboto,sans-serif" required>

      <label style="float: left;font-family: Roboto,sans-serif"><b>รีวิว</b></label>
      <textarea class="w3-input w3-border"  id="review" name="review" type="text" placeholder="รีวิว.." style="font-family: Roboto,sans-serif" required></textarea>
      <br>
      ...
      <div class="star-rating">
              ...
              <input type="hidden" name="star" id="star" class="rating-value" required>
      </div>
      <br>
      <button type="submit" class="btn btn-light" style="background-color: rgba(0, 0, 0, 0.6); color: #fff;" id="id" name="id" value="<?php echo $id?>" require>Post</button>
    </div>
  </div>
  </form>
</div>
...
<div id="login" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom" style="padding:20px; max-width: 550px;">
    ...
    <form action="../admin/login.php" method="post">
      ...
      <p><input class="w3-input w3-border" type="text" id="user" name="user" placeholder="Enter Username" required></p>

      <label style="float: left; width: 11%;"><b>Password</b></label>
      <p><input class="w3-input w3-border" type="password" id="pass" name="pass" placeholder="Enter Password" required></p>
      <BUTTON type="submit" value="Login" class="w3-button w3-padding-large w3-dark-grey w3-margin-bottom " required>Login</BUTTON>
    </form>
    </div>
  </div>
</div>
